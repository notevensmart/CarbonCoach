        ...
        >
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-stone-600">
                Write naturally. CarbonCoach will estimate what it safely can and show what needs
                more detail.
              </p>
            </div>
          </div>
          ...
          <form className="mt-5" onSubmit={handleSubmit}>
            ...
            <textarea
              ...
              placeholder="e.g., Used a 2 kW heater for 3 hours, drove 7k, and recycled 500g of plastic..."
              value={entry}
            />
